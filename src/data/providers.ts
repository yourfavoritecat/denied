...
export const providers: Provider[] = [
  ...
  },
  {
    ...
    procedures: [
      { name: "Zirconia Crown", priceRange: "$350–$450", usPrice: 1500, savings: 73, duration: "2–3 days" },
      ...
      { name: "Porcelain Veneer", priceRange: "$380–$500", usPrice: 1800, savings: 75, duration: "2–3 days" },
      { name: "Root Canal", priceRange: "$280–$400", usPrice: 1100, savings: 69, duration: "1–2 hours" },
    ],
    reviewsList: [
