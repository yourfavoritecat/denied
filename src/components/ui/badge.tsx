...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-bold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-[url('/images/btn-mint.jpg')] bg-[length:100%_100%] text-black shadow-elevated hover:shadow-glow-mint",
        secondary:
          "border-transparent bg-[url('/images/btn-peach.png')] bg-[length:100%_100%] text-black shadow-elevated hover:shadow-glow-peach",
        destructive:
