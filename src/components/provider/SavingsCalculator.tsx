              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-1 ml-1">
                    ...
                    <span className="text-primary font-bold min-w-[1.25rem] text-center">×{qty}</span>
                    <button
                      onClick={() => handleQty(name, 1)}
                      className="hover:text-white/80 transition-colors disabled:opacity-30"
                      disabled={qty >= 20}
                  ...
                  <span className="text-primary font-bold">${(localPrice * qty).toLocaleString()}</span>
                  <button
        ...
        {isActive && (
          ...
          >
                  ...
                  return (
                    <div key={name} className="flex items-center justify-between text-sm">
                      ...
                      <div className="flex items-center gap-4 shrink-0">
                        ...
                        <span className="text-primary font-semibold">${(localPrice * qty).toLocaleString()}</span>
                      </div>
                    </div>
                  );
                })}
            ...
            <div className="grid grid-cols-3 gap-4 mt-4 text-center">
              ...
              <div>
                <p className="text-xs text-secondary uppercase tracking-wider mb-1">You Save</p>
                <p className="text-2xl sm:text-3xl font-bold text-secondary">
                  ${animatedSavings.toLocaleString()}
                </p>
                <p className="text-sm font-semibold text-secondary">{savingsPct}% off</p>
              </div>
            </div>
