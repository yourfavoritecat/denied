      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-hero border-border/50">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">{loginOnly ? "Log In" : "Welcome"}</CardTitle>
            <CardDescription>{loginOnly ? "Sign in to your account" : "Sign in to manage your trips and profile"}</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            {loginOnly ? (
              /* Login-only mode — no tabs, just the login form */
              <div>
                ...
                <p className="text-center text-xs text-muted-foreground mt-6">
                  denied.care is invite-only right now.{" "}
                  <Link to="/" className="text-primary hover:underline font-medium">join the waitlist</Link>{" "}
                  to get early access.
                </p>
              </div>
            ) : (
              /* Full auth mode with tabs */
              <>
